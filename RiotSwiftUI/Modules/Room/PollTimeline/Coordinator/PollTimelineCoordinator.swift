...
final class PollTimelineCoordinator: Coordinator, PollAggregatorDelegate {
    ...
    init(parameters: PollTimelineCoordinatorParameters) throws {
        ...
        pollTimelineViewModel = PollTimelineViewModel(timelinePoll: mapPoll(pollAggregator.poll))
    ...
    func toPresentable() -> UIViewController {
        return VectorHostingController(rootView: PollTimeline(viewModel: pollTimelineViewModel.context))
    }
    ...
    func endPoll() {
        self.parameters.room.sendPollEnd(for: parameters.pollStartEvent, localEcho: nil, success: nil) { error in
    ...
    func pollAggregatorDidUpdateData(_ aggregator: PollAggregator) {
        pollTimelineViewModel.dispatch(action: .updateWithPoll(mapPoll(aggregator.poll)))
    }
