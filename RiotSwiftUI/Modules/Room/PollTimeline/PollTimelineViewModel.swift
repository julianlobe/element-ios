...
class PollTimelineViewModel: PollTimelineViewModelType {
    ...
    static func updateSingleSelectPollLocalState(_ state: inout PollTimelineViewState, selectedAnswerIdentifier: String, callback: ViewModelCallback?) {
    ...
    static func updateMultiSelectPollLocalState(_ state: inout PollTimelineViewState, selectedAnswerIdentifier: String, callback: ViewModelCallback?) {
    ...
    static func informCoordinatorOfSelectionUpdate(state: PollTimelineViewState, callback: ViewModelCallback?) {
